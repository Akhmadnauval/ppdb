...
if (isset($_GET['id'])) {
    ...
    $akun_cek = mysqli_fetch_array($query_cek, MYSQLI_BOTH);
}
?>
...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">Admin PPDB</span>
            </a>
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="ppdb-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="pendaftar/pendaftar.php">
            ...
            <li class="nav-item">
                ...
                <ul id="pengguna-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="user/user.php" class="active">
    ...
    <main id="main" class="main">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id_register" value="<?php echo $akun_cek['id_register']; ?>" readonly>

                                <div class="col-md-6">
                                    <label>NISN</label>
                                    <input type="text" name="nisn" class="form-control" value="<?php echo $akun_cek['nisn']; ?>" readonly  />
                                </div>
                                <div class="col-md-6">
                                    <label>Nama</label>
                                    <input type="text" name="nama_pendaftar" class="form-control" value="<?php echo $akun_cek['nama_pendaftar']; ?>" />
                                </div>
                                <div class="col-md-6">
                                    <label>Username</label>
                                    <input type="text" name="username" class="form-control" value="<?php echo $akun_cek['username']; ?>" />
                                </div>
                                <div class="col-md-6">
                                    <label>Password</label>
                                    <input type="text" name="password" class="form-control" value="<?php echo $akun_cek['password']; ?>" />
                                </div>


                                <div class="text-right">
                                    <button type="submit" name="Ubah" class="btn btn-primary">Ubah</button>
                                    <a href="akun_pendaftar.php" class="btn btn-secondary">Kembali</a>
                                </div>
        ...
        if (isset($_POST['Ubah'])) {
            ...
            if (!empty($sumber)) {
                $sql_ubah = "UPDATE tb_register SET
			nisn='" . $_POST['nisn'] . "',
			nama_pendaftar='" . $_POST['nama_pendaftar'] . "',
			username='" . $_POST['username'] . "',
            password='" . $_POST['password'] . "'
            WHERE id_register='" . $_POST['id_register'] . "'";
            ...
            if ($query_ubah) {
                ...
                echo "<meta http-equiv='refresh' content='0; url=edit-akun.php'>";
            }
        }
        ?>
