    ...
    <main id="main" class="main">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo $data_cek['id']; ?>" readonly>

                                <div class="col-md-6">
                                    <label>Username</label>
                                    <input type="text" name="username" class="form-control" value="<?php echo $data_cek['username']; ?>" readonly />
                                </div>
                                <div class="col-md-6">
        ...
        if (isset($_POST['Simpan'])) {
            ...
            if ($query_ubah) {
                ...
                echo "<meta http-equiv='refresh' content='0; url=edit-user.php'>";
            }
        }
        ?>
